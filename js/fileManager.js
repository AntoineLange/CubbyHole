...
//Retourne le chemin des items dans le presse papier
...
//Retourne la taille de stockage du dossier courant
...
//Ajoute des items au presse papier
...
//Affiche le contenu du presse papier
...
//Créer l'url de téléchargement d'un item
...
if (jQuery) (function(jQuery){
	...
	jQuery.extend(jQuery.fn, {
		fileManager: function(o) {
			...
			if( o.script == undefined ) o.script = 'lib/fileManager.php';
			...
			//Lors d'un clic sur le bouton upload
			...
			//Fonction affichant les fichiers dans le tableau principal
			...
			//Fonction affichant les dossiers dans le tableau principal
			...
			//Fonction envoyant les fichiers du drag and drop sur le serveur
			function sendFileToServer(formData,status)
			{
			    var uploadURL = "./lib/fileManager.php"; //Upload URL
			...
			//Fonction créant la bar de chargement du fichier en cours d'upload
			...
			//Fonction affichant le contenu HTML des fichiers et des dossiers
			...
			//Fonction affichant l'arborescence des dossiers
			...
			cusElement.prepend('<a href="#" class="label label-primary" id="rootLink">Racine</a>');
